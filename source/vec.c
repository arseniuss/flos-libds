...
void
ds_vec_ensure_free_space(ds_vec_t *vector, size_t type_size) {
...
void
ds_vec_create_ext(ds_vec_t *vector, ds_alloc_func_t alloc_func, ds_realloc_func_t realloc_func,
...
void
ds_vec_reserve(ds_vec_t *vector, size_t new_size, size_t type_size) {
